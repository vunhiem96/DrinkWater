   ...
   var check:Boolean?=false
        ...
        h.post(
            object : Runnable {
                override fun run() {
                    ...
                    else if (y=="23:59" && day==Calendar.TUESDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterTue"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if (y=="23:59" && day==Calendar.WEDNESDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterWed"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if (y=="23:59" && day==Calendar.THURSDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterThu"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if (y=="23:59" && day==Calendar.FRIDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterFri"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if (y=="23:59" && day==Calendar.SATURDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterSar"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if (y=="23:59" && day==Calendar.SUNDAY){
                        val intent1 = Intent()
                        intent1.action = "addWaterSun"
                        applicationContext!!.sendBroadcast(intent1)
                    }
                    else if(currentDate2 == 1 && y=="00:00"){
                        val intent1 = Intent()
    ...
    internal var receiverService: BroadcastReceiver = object : BroadcastReceiver(){
        override fun onReceive(p0: Context?, intent: Intent) {
            ...
            else if(intent.action == "notificationWater"){
...
//                    startForeground(NOTIFICATION_ID, notification)
            ...
            else if(intent.action == "addWaterMon"){
            ...
            else if(intent.action == "addWaterTue"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "addWaterWed"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "addWaterThu"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "addWaterFri"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "addWaterSar"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "addWaterSun"){
                var waterDrink2 = AppConfig.getWaterLevel(applicationContext)!!.toInt()
                var waterDrink = AppConfig.getWaterLevel(applicationContext)!!.toFloat()
                var waterGold = AppConfig.getGoldDrink(applicationContext)
                val waterGold2 = waterGold!!.replace("[.]".toRegex(), "").toFloat()
            ...
            else if(intent.action == "resetall"){
            ...
            else if(intent.action == "resetallMonth"){
                for (i in 1..31){
